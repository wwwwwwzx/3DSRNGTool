...
namespace Pk3DSRNGTool
{
    internal static class StringItem
    {
        ...
        {
            new [] { "Legendary", "Legendary", "定点传说" },
            new [] { "Starters", "Starters", "御三家" },
            new [] { "In-Game Gift", "In-Game Gift", "礼物" },
            new [] { "In-Game Trade", "In-Game Trade", "游戏内交换" },
            new [] { "Pokemon Link", "Pokemon Link", "宝可梦连接" },
            new [] { "Poke Transporter", "Poke Transporter", "宝可虚拟传送" },
            new [] { "Normal Stationary", "Normal Stationary", "普通定点" },
            new [] { "Fossils", "Fossils", "复原化石" },
            new [] { "Hoenn Legendary", "Hoenn Legendary", "丰缘传说" },
            new [] { "Johto Legendary", "Johto Legendary", "城都传说" },
            new [] { "Sinnoh Legendary", "Sinnoh Legendary", "神奥传说" },
            new [] { "Unova Legendary", "Unova Legendary", "合众传说" },
            new [] { "Island Scan", "Island Scan", "岛屿搜索" },
            new [] { "Normal Wild", "Normal Wild", "普通野外" },
            new [] { "Berry Tree", "Berry Tree", "果树" },
            new [] { "Cave Drop", "Cave Drop", "洞窟坠物" },
            new [] { "Rustling Bush", "Rustling Bush", "晃动树影" },
            new [] { "Friend Safari", "Friend Safari", "朋友狩猎区" },
            new [] { "Cave Shadows", "Cave Shadows", "洞窟阴影" },
            new [] { "Trap", "Trap", "沙尘" },
            new [] { "Poke Pelago", "Poke Pelago", "宝可度假地" },
            new [] { "Johto Starters", "Johto Starters", "城都御三家" },
            new [] { "Legendary Titans", "Legendary Titans", "三神柱" },
            new [] { "Trash Can", "Trash Can", "垃圾桶" },
            new [] { "Rock Smash", "Rock Smash", "碎岩" },
            new [] { "Horde", "Horde", "群战" },
            new [] { "Poke Radar", "Poke Radar", "宝可雷达" },
            new [] { "Fishing", "Fishing", "钓鱼" },
            new [] { "None", "None", "无" },
        };
        ...
        public static readonly string[] ANY_STR = { "Any", "Any", "任意" };
        public static readonly string[] NONE_STR = { "None", "None", "无" };
        public static readonly string[] SETTINGERROR_STR = { "Error at ", "Error at ", "出错啦0.0 发生在" };
        public static readonly string[] NOSELECTION_STR = { "Please Select", "Please Select", "请选择" };
        public static readonly string[] FILEERRORSTR = { "Invalid file!", "Invalid file!", "文件格式不正确" };
        public static readonly string[] NORESULT_STR = { "No Result", "No Result", "没有结果" };
        public static readonly string[] WAIT_STR = { "Please Wait...", "Please Wait...", "请稍后..." };
        public static readonly string[] INVALID_STR = { "Invalid Input", "Invalid Input", "输入格式不正确" };
