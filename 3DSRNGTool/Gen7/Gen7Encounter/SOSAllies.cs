...
namespace Pk3DSRNGTool
{
    public class SOSAllies
    {
        ...
        private static SOSAllies[] Table =
        {
            ...
            new SOSAllies{ Species = 2090, slottype = 4, Ally = new[] {2091}, Ultra = true, },
            ...
            new SOSAllies{ Species = 238, slottype = 4, Ally = new[] {124}, Baby = 440, },
            ...
            new SOSAllies{ Species = 438, slottype = 4, Ally = new[] {185}, Baby = 440, },
            new SOSAllies{ Species = 439, slottype = 4, Ally = new[] {122}, Baby = 440, },
            new SOSAllies{ Species = 446, slottype = 4, Ally = new[] {143}, Baby = 440, },
            new SOSAllies{ Species = 447, slottype = 4, Ally = new[] {448}, Baby = 440, Ultra = true, },
            new SOSAllies{ Species = 447, slottype = 4, Ally = new[] {448}, Baby = 113, Ultra = false,},
            ...
            new SOSAllies{ Species = 732, slottype = 4, Ally = new[] {733}, Locations = new[]{108,164,166}, Ultra = true, },
            new SOSAllies{ Species = 734, slottype = 2, Ally = new[] {735}, Locations = new[]{058}, Ultra = true, },
            new SOSAllies{ Species = 737, slottype = 11, Ally = new[] {738,735}, Locations = new[]{138}, Ultra = true, },
